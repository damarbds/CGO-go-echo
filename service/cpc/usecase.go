...
type Usecase interface {
	GetAllCity(ctx context.Context,page,limit,offset int)([]*models.CityDto,error)
	...
	GetAllProvince(ctx context.Context,page,limit,offset int)([]*models.ProvinceDto,error)
	...
	GetAllCountry(ctx context.Context,page,limit,offset int)([]*models.CountryDto,error)
	GetCountryById(ctx context.Context,id int)(models.CountryDto,error)
	CreateCountry(ctx context.Context,p *models.NewCommandProvince,token string)(*models.ResponseDelete,error)
	UpdateCountry(ctx context.Context,p *models.NewCommandProvince,token string)(*models.ResponseDelete,error)
