...
type Repository interface {
	...
	DeleteCity(ctx context.Context, id int,deleted_by string) error
	...
	DeleteProvince(ctx context.Context, id int,deleted_by string) error
	...
	DeleteCountry(ctx context.Context, id int,deleted_by string) error
}
