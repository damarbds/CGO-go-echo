...
type Usecase interface {
	...
	FilterSearchExp(ctx context.Context, isMerchant bool, token, status, cityID string, harborsId string, expTypeId string, startDate string, endDate string, guest string, trip string, bottomPrice string, upPrice string, sortBy string, page, limit, offset int) (*models.FilterSearchWithPagination, error)
