...
type Usecase interface {
	...
	FilterSearchExp(ctx context.Context, cityID string, harborsId string, expTypeId string, startDate string, endDate string, guest string, trip string, bottomPrice string, upPrice string, sortBy string) ([]*models.ExpSearchObject, error)
