...
type Usecase interface {
	...
	FilterSearchTrans(ctx context.Context, isMerchant bool, token, search, status, sortBy, harborSourceId, harborDestId, depDate, class string, isReturn bool, depTimeOptions, arrTimeOptions, guest, page, limit, offset int,returnTransId string,notReturn string) (*models.FilterSearchTransWithPagination, error)
}
