...
type Usecase interface {
	...
	GetByUserID(ctx context.Context, transactionStatus, bookingStatus int, token string, page, limit, offset int) (*models.MyBookingWithPagination, error)
